...
if (isset($_POST['tgl_mulai'])) {
    ...
    $strc[] = "nota_potongan.tanggal_pengajuan BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
    $jmlh++;
}
if (isset($_POST['id_verifikasi'])) {
    $id_verifikasi = $_POST['id_verifikasi'];
    $strc[] = "nota_potongan.id_verifikasi='$id_verifikasi'";
    $jmlh++;
}
...
<!-- Form pencarian -->
<div>
    <form action="index.php?halaman=nota_potongan" method="post" class="form">
        <br/>
        <div class="row">
            <div class="col-md-2">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <?php while ($pecah = $result->fetch_assoc()) { ?>
                      <tr>
                          ...
                          <td><a href="index.php?halaman=lihatpotongan&id_nota_potongan=<?php echo $pecah['id_nota_potongan'];?>" class="btn btn-secondary">File</a></td>
