<h4><span class="text-muted fw-light"> Potongan |</span> Nota Potongan</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="overflow:auto">
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td width=30%>ID nota potongan</td>
                            ...
                            <tbody>
                                ...
                                <?php echo "<tr id='change_form".$no."' style='display:none'>"; ?>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <td> <?php echo "<input type='text' class='form-control' placeholder='Keterangan potongan' name='keterangan_potongan' value='".$nom['keterangan_potongan']."'>"; ?></td>
                                        <td align=center>
                                    ...
                                    <?php
                                        ...
                                        if (isset($_POST[$ch])){
                                            $sql=$koneksi->query("UPDATE `transaksi_potongan`
                                                SET `Id_Jenis_Pemeriksaan` = '$_POST[potongan]', `transaksi_potongan` = '$_POST[keterangan_potongan]'
                                                WHERE `id_nota_potongan` = '$_GET[id_nota_potongan]' AND `Id_Jenis_Pemeriksaan` = '$nom[Id_Jenis_Pemeriksaan]'
                                            ");
                                            if($sql){
                                ...
                                <!--Form Tambah Data-->
                                        ...
                                        <tr id="add_form" style="display: none">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <td><input type="text" class="form-control" placeholder="Keterangan potongan" name="keterangan_potongan"></td>
                                                <td align=center>
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    $sql=$koneksi->query("INSERT INTO `transaksi_potongan`(id_nota_potongan, id_potongan, keterangan_potongan) 
                                                        VALUES('$_POST[id_nota_potongan]', '$_POST[potongan]', '$_POST[keterangan_potongan]')
                                                    ");
                                                    $ttl = mysqli_query($koneksi, "SELECT COUNT(id_potongan) AS t
                                                        FROM transaksi_potongan
                                                        WHERE id_nota_potongan = '$_GET[id_nota_potongan]'");
                                                    $sss = mysqli_fetch_array($ttl)['t']++;
                                                    $sql2=$koneksi->query("UPDATE `nota_potongan`
