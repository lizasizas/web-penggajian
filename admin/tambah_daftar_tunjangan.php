<h4><span class="text-muted fw-light"> Tunjangan |</span> Daftar Tunjangan</h4>
                    ...
                    <div class="card-body" style="overflow:auto">
                        <?php
                            ...
                            $q1 = mysqli_query($koneksi, "SELECT * FROM karyawan
                                JOIN daftar_tunjangan ON daftar_tunjangan.id_karyawan = karyawan.id_karyawan
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td width=70%><?php echo $qdata['id_daftar_tunjangan'] ?></td>
                            </tr>
                            <tr>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $q2 = mysqli_query($koneksi, "SELECT *
                                        ...
                                        WHERE transaksi_tunjangan.id_daftar_tunjangan = '$_GET[id_karyawan]'");
                                ...
                                <?php echo "<tr id='change_form".$no."' style='display:none'>"; ?>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <td align=center>
                                            ...
                                            <?php echo "<button type='submit' style='width:45%' name='update".$nom['id_daftar_tunjangan']."&".$nom['id_tunjangan']."' class='btn btn-sa'>Simpan</button>"; ?>
                                        </td>
                                    </form>
                                    <?php
                                        $ch = "update".$nom['id_daftar_tunjangan']."&".$nom['id_tunjangan'];
                                        if (isset($_POST[$ch])){
                                            $sql=$koneksi->query("UPDATE `transaksi_tunjangan`
                                                ...
                                                WHERE `id_daftar_tunjangan` = '$_GET[id_daftar_tunjangan]' AND `Id_Jenis_Pemeriksaan` = '$nom[Id_Jenis_Pemeriksaan]'
                                            ");
                                            if($sql){
                                                echo "<script>window.location = 'index.php?halaman=hasil&id_daftar_tunjangan=".$_GET['id_daftar_tunjangan']."'</script>";
                                            }else{
                                ...
                                <tr></tr>
                                        <?php echo "<tr id='delete".$no."' style='display: none;'>"; ?>
                                            <td colspan=5 align=center>
                                                ...
                                                <?php echo "<a class='btn btn-del' style='width: 45%' href='hapus_transaksi_tunjangan.php?idc=".$nom['id_daftar_tunjangan']."&idj=".$nom['id_tunjangan']."&type=hasil'>Ya</a>"; ?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="add_form" style="display: none">
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    $sql=$koneksi->query("INSERT INTO `transaksi_tunjangan`(id_daftar_tunjangan, id_tunjangan, keterangan_tunjangan) 
                                                        VALUES('$_POST[id_daftar_tunjangan]', '$_POST[tunjangan]', '$_POST[keterangan_tunjangan]')
                                                    ");
                                                    $ttl = mysqli_query($koneksi, "SELECT COUNT(id_tunjangan) AS t
                                                        FROM transaksi_tunjangan
                                                        WHERE id_daftar_tunjangan = '$_GET[id_daftar_tunjangan]'");
                                                    $sss = mysqli_fetch_array($ttl)['t']++;
                                                    $sql2=$koneksi->query("UPDATE `daftar_tunjangan`
                                                    ...
                                                    if($sql AND $sql2){
                                                        ...
                                                        echo "<script>alert('Proses gagal'); window.location = 'index.php?halaman=daftar_tunjangan'</script>";
                                                    }
                                                }
                                            ?>
                                        </tr>
