...
$query="SELECT *, SUM(slip_gaji.gaji_bersih) AS total FROM slip_gaji 
    ...
    inner join divisi on karyawan.id_divisi = divisi.id_divisi $strw 
...
<h4><span class="text-muted fw-light"> LAPORAN |</span> GAJI BERDASARKAN DIVISI</h4>
<div>

<form action="index.php?halaman=laporan_gaji_divisi" method="post" class="form">
