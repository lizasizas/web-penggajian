...
$query = "SELECT *, COUNT(nota_tunjangan.id_verifikasi) AS total, SUM(nota_tunjangan.total_tunjangan) AS totalp
          FROM nota_tunjangan
          JOIN verifikasi ON nota_tunjangan.id_verifikasi = verifikasi.id_verifikasi
         $strw
          GROUP BY nota_tunjangan.id_verifikasi
          ORDER BY total DESC";
...
?>
<h4><span class="text-muted fw-light"> LAPORAN |</span> PENGELUARAN TUNJANGAN</h4>
<div>
<form action="index.php?halaman=laporan_verifikasi_tunjangan" method="post" class="form">
    <div class="row">
