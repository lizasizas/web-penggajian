                                    ...
                                    <?php
                                        ...
                                        if (isset($_POST[$ch])){
                                            ...
                                            if($sql){
                                                ...
                                                echo "<script>alert('Proses gagal'); window.location = 'index.php?halaman=notapotongan'</script>";
                                            }
                                        }
                                    ?>
                                </tr>
                                        ...
                                        <tr id="add_form" style="display: none">
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    ...
                                                    if($sql){
                                                        echo "<script>window.location = 'notapotongan.php'</script>";
                                                    }else{
                                                        echo "<script>alert('Proses gagal'); window.location = 'notapotongan.php'</script>";
                                                    }
                                                }
                                            ?>
                                        </tr>
