            ...
            <div>
             ...
             <?php
              if(isset($_POST["registrasi"]))
              {
                  ...
                  $sql=$koneksi->query("INSERT INTO karyawan(id_karyawan,nama_karyawan,no_rekening,id_jabatan,id_golongan,id_divisi,id_agama,id_status_nikah,jumlah_anak, username, password) 
                  VALUES('$kd_idk','$_POST[nama_karyawan]','$_POST[no_rekening]','$_POST[id_jabatan]','$_POST[id_golongan]','$_POST[id_divisi]','$_POST[id_agama]','$_POST[id_status_nikah]','$_POST[jumlah_anak]','$_POST[username_karyawan]','$_POST[password_karyawan]')");
                  if($sql)
                  {
